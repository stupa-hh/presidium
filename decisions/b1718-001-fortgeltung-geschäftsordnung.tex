...
\begin{document}
    ...
    \section*{Beschluss des Studierendenparlamentes vom 6. April 2017}
    \subsection*{Fortgeltung Geschäftsordnung}

    Die bestehende Geschäftsordnung in der Fassung vom 14. April 2016 gilt fort.
\end{document}
