...
\begin{document}
    ...
    \section*{Einladung zur sechsten Sitzung des Studierendenparlaments}

    \textit{Liebe Parlamentarier*Innen,\\
    liebe AStA-Referent*Innen,\\
    liebe Interessierte,}

    hiermit laden wir euch zur sechsten Sitzung des Studierendenparlaments
    in der Legislatur 2016/2017 ein:

    \textbf{Donnerstag, den 30. Juni 2016\\
    Um 18.00 Uhr c.t.\\
    ...
    \begin{enumerate}[label={\textbf{Top \theenumi}},leftmargin=*]
        ...
        \item Haushalt 2016/2017 (V1617-025) (75 Min.)
        \begin{enumerate}
            \item 2. Lesung (70 Min.)
            \item 3. Lesung (5 Min.)
        \end{enumerate}
        \item Nachtragshaushalt 2015/2016 (V1617-026) (25 Min.)
        \begin{enumerate}
