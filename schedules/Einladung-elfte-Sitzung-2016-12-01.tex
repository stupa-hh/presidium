...
\begin{document}
    ...
    \section*{Einladung zur 11. Sitzung des Studierendenparlaments}

    \textit{Liebe Parlamentarier*Innen,\\
    liebe AStA-Referent*Innen,\\
    liebe Interessierte,}

    hiermit laden wir euch zur 11. Sitzung des Studierendenparlaments
    in der Legislatur 2016/2017 ein:

    \textbf{Donnerstag, den 1. Dezember 2016\\
    Um 18.00 Uhr c.t.\\
    Im Raum S08\\
    Von-Melle-Park 9\\
    20146 Hamburg}
